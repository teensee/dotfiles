...
Vendored [superpowers](https://github.com/obra/superpowers) skills in `opencode/skills/` — shared
with Claude Code via `~/.claude/skills`; MIT © 2025 Jesse Vincent (see `opencode/skills/LICENSE`).
