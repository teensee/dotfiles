...
Создай рабочую директорию (`mkdir -p` — будет запрошено подтверждение) и файл `task.md` с текстом
задачи.
...
После создания скажи: «Задача создана → .opencode/work/<branch>/task.md. Дополни описание при
необходимости и запускай /res».
