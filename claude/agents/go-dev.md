---
name: go-dev
description: Go разработчик. TRIGGER: файлы *.go, go.mod; микросервисы, CLI, RabbitMQ consumers, HTTP-серверы, XML/JSON парсинг, sqlx, goroutines. SKIP: PHP, SQL без Go-контекста, DevOps.
