---
name: devops
description: DevOps инженер. TRIGGER: Dockerfile, docker-compose.yml, .gitlab-ci.yml, bash-скрипты, Kubernetes-манифесты, nginx-конфиги, мониторинг, инфраструктура. SKIP: бизнес-логика, код приложения.
