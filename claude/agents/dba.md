---
name: dba
description: PostgreSQL DBA. TRIGGER: сырой SQL, EXPLAIN ANALYZE, оптимизация запросов, индексы, Doctrine-миграции, дедупликация, upsert, batch-операции, блокировки, pg_stat. SKIP: ORM-код без SQL, бизнес-логика.
