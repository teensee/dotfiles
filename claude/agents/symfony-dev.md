---
name: symfony-dev
description: Symfony/PHP backend разработчик. TRIGGER: файлы *.php, composer.json; Symfony, Doctrine ORM, Messenger, API Platform, сериализация, миграции, DI, события. SKIP: Go-код, чистый SQL без PHP-контекста, тесты (→ test-writer).
...
- Генерируй через diff, проверяй SQL
